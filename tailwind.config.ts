  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "glow-pulse": {
          "0%, 100%": {
            boxShadow: "0 0 30px hsla(190, 100%, 50%, 0.6), 0 0 60px hsla(270, 100%, 60%, 0.4)",
          },
          "50%": {
            boxShadow: "0 0 40px hsla(190, 100%, 50%, 0.8), 0 0 80px hsla(270, 100%, 60%, 0.6)",
          },
        },
        float: {
      ...
      animation: {
        ...
        "equalizer-3": "equalizer-3 0.7s ease-in-out infinite 0.4s",
      },
      backgroundImage: {
